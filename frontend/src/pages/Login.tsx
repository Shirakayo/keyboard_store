...
const Login = () => {
  ...
  const showAlertSuccess = () => {
    Swal.fire({
      title: "Success",
      customClass: {
        container: `${style.success_alert_container}`,
        icon: `${style.success_alert_icon}`,
        popup: `${style.success_alert_popup}`,
        confirmButton: `${style.success_alert_confirmButton}`,
        title: `${style.success_alert_title}`,
      },
        ...
        <div className={style.block_form}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className={style.form}>
            ...
            <small className={style.save_check}>
              ...
              <input
                type="checkbox"
                onChange={(e) => setSaveStatus(e.target.checked)}
              />
            </small>
